...
children:
  - { type: "section", title: "🎯 Munkanap kezdés", children: [
      { type: "text", text: "• `/fokusz` — pillanatkép mindenből, darálási sorrend" }
    ]}
...
fallbackText: "Parancsok: /fokusz /projektek /teendok /naptar /email /hirek /edzo /wiki /szia /help"
```
