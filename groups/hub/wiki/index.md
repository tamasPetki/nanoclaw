...
Tomi konszolidált tudásbázisa. Karpathy LLM-Wiki pattern szerint maintained.

## Projektek

### PietScarlet (építőipar)
- [PietScarlet Kft. — cég-szintű ernyő](projects/pietscarlet/summary.md) — email workflow, Erika, scam-minták, Drive-scope
- [Görgey 32 (Vác)](projects/gorgey32/summary.md) — aktív kivitelezés, 7 lakás + iroda, alvállalkozók, redőny-megállapodások
- [Csobánka, Kilátó u.](projects/csobanka/summary.md) — korai előkészítés, ~2 693 m², közmű-igénylés
- [Felső Törökhegy](projects/torokhegyi/summary.md) — telekalakítás, ETDR, MOL bányaszolgalom + ÉKM kisajátítás blokkoló

### Vendéglátás
- [Lupa Öböl Kft.](projects/lupaobol/summary.md) — strand & beachbar, szezonkezdés-előkészítés
- [Trinken Essen Kft.](projects/trinkenessen/summary.md) — Waikiki Beachbar + Tapadeli étterem

## Egészség / Edző
- [Edző — edzésterv & protokollok](health/edzo.md) — Upper/Lower split, 1800 kcal rekomp, hideg fürdő apnoe-protokoll, MAD nyitott
- [Edző — fogyás napló & mérföldkövek](health/edzo-history.md) — induló 97.2 kg, cél 85 kg, heti összefoglalók + napi napló
