...
- **2026-06-04 — state.json adatvesztés a container-rebuild során.** A `rezerver/state.json` ELTŰNT a ~15:30-as container-rebuild után (a facebook-skill rebuild, amit Tomi jóváhagyott). Bizonyíték: rezerver-email MCP account created_at=2026-06-04T15:32Z (config újra-provisionált), rezerver/ dir mtime 14:31, .crm-export 15:42-kor újraíródott. A reggeli (07:53) reddit warmup MÉG olvasta/írta — tehát a rebuild törölte. A CRM/venue adat biztonságban (host DB). A reddit warmup-state-et autoritatívan visszaállítottam (a reggeli teljes olvasásból), az FB warmup-state best-effort, ellenőrizendő a következő FB-session elején. **Tanulság: a rebuild NEM őrzi meg garantáltan a workspace-JSON-okat — a kritikus warmup-state-et (reddit/fb) is érdemes a host CRM-DB-be migrálni (ahogy a venue-adat már ott van), vagy minden rebuild előtt menteni.** Ez visszatérő mintázat (lásd 2026-06-02 context-compaction loss is): a sérülékeny JSON-ok ismételten elvesznek.

- **2026-06-05 — Referral-hub mintázat: catering-cég = kész venue-lead-forrás + kétirányú warm-intro.** Az alvállalkozó-gyűjtés első köréből a Budapest Party Service (prémium catering, partner id 22) a SAJÁT honlapján nyíltan listázza a partnerhelyszíneit. Ebből venue-pipeline-leadeket nyertünk: 4 független rendezvényhelyszín stubként felvéve a venue-cron dúsítására (Europa Event Center #78, Dunai Csónakház #79, RaMArT #80, Paprika Revue House #81). **Két tanulság:** (1) a magas referral_potential-ű alvállalkozók (főleg cateringesek, akiknek preferált-helyszín-listájuk van) egyszerre lead-forrás ÉS kétirányú warm-intro csatorna a venue-k felé — outreach-aktiváláskor a vendor-kapcsolat melegebb belépő, mint a cold email. (2) A BPS partnerlistájának INTÉZMÉNYI fele (Szépművészeti Múzeum, Pesti Vigadó, Várkert Bazár, Kiscelli Múzeum, Festetics Palota, Millenáris) exkluzív-caterer lock-inben van — ez ugyanaz az enterprise-mintázat mint a hotelláncoknál (fit 1-2), ezért NEM vettem fel őket, csak a független helyszíneket. Visszatérő szabály-jelölt: intézményi/állami venue + exkluzív caterer = alacsony fit, deprioritás.

- **2026-06-05 — Inbox-állapot:** a `hello@rezerver.com` fiók tele van SMS-gateway signup/verify/payment tranzakciós levelekkel (Twilio, Telnyx, Vonage, Bird, GatewayAPI, Brevo) — Tomi SMS-infrát épít (vélhetően foglalás-visszaigazolás/emlékeztető). NULLA inbound venue-lead vagy megválaszolandó kérdés. Csendes fázis tartva, reply nem kellett.
