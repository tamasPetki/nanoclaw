...
**Trigger:** Hétköznap 9/13/17 órakor pre-filter script futtatja, csak akkor ébreszt fel ha új levél van a `hello@trinkenessen.eu` fiókban. Asszisztens átadja az utolsó UID-t.
...
- **Full body** lekéréséhez a saját email MCP/tool-omat használom
- Ha hiba van, konkrét hibaüzenetet jelzek vissza (lásd lent: failover)

## UID state

Saját UID state-et tárolok itt: `/workspace/agent/trinkenessen-last-uid.txt`
...
TRINKENESSEN_IMAP_*), és chat-üzenetben átadja. A Trinken Essen MCP halott állapotában is
feldolgozható.
